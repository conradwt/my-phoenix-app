defmodule MyPhoenixAppWeb.FeatureCase do
  @moduledoc """
  ...
  by setting `use MyPhoenixAppWeb.FeatureCase, async: true`, although
  ...
  using do
    quote do
      ...
      import MyPhoenixAppWeb.FeatureCase

      # Customizations
      import PhoenixTest
      import MyPhoenixApp.Factory
    end
  end
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    ...
    scope = MyPhoenixApp.Accounts.Scope.for_user(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    MyPhoenixApp.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
