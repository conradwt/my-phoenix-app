...
config :my_phoenix_app, MyPhoenixAppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "j4rjUR/eA4PYI34CImgJPWv64ZqPY3YA9NeRTkPcdI16WZrILmXzrdvcUQIZlG82",
  watchers: [
...
config :my_phoenix_app, MyPhoenixAppWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/my_phoenix_app_web/router\.ex$"E,
      ~r"lib/my_phoenix_app_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
